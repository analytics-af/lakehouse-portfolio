...
path_minio_gold = 's3://gold/comex/dim_ncm_sh'
...
dim_ncm_sh = con.sql(f"""
                 
              WITH silver_ncm_sh as
              (
              SELECT DISTINCT
                     cod_ncm,
                     no_ncm_por,
              ...
              SELECT
                     ...
                     S.no_ncm_por,
                     S.nome_secao
              FROM silver_ncm_sh S
              WHERE S.cod_ncm NOT IN( SELECT DISTINCT cod_ncm FROM delta_scan('{path_minio_gold}') )
